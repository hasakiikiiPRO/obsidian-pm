...
import { PortfolioTimelineView, PM_PORTFOLIO_TIMELINE_VIEW_TYPE } from './views/PortfolioTimelineView'
...
export default class PMPlugin extends Plugin {
  ...
  async onload(): Promise<void> {
    ...
    this.registerView(PM_PORTFOLIO_TIMELINE_VIEW_TYPE, (leaf) => new PortfolioTimelineView(leaf, this))
    ...
    this.addCommand({
      id: 'open-portfolio-timeline',
      name: t('command.openPortfolioTimeline'),
      callback: () => {
        void this.router.openPortfolioTimeline()
      }
    })
